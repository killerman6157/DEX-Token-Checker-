# bot/main.py
# Wannan fayil din zai kula da Telegram bot din.
# Zai fara bot, saita umarni, kuma ya amsa sakonni.
    ...
    try:
        ...
        if result:
            response_message = (
                ...
                f"**Rug Pull Risk:** {'✅ LOW' if result.get('rug_pull_risk', 'HIGH') == 'LOW' else '⚠️ HIGH'}\n"
